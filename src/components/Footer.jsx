        ...
        <div className='max-w-full mx-auto'>
            <div className='w-full flex-col flex justify-center items-center'>
                ...
                <div className='w-full bg-gray-800 px-[165px] py-[64px] flex flex-wrap justify-between sm:justify-center
                    ...
                    <div className='w-[635px] sm:w-full lg:w-full'>
                        <div className='w-full flex items-center justify-between flex-wrap sm:justify-center gap-8'>
                            <div className='sm:w-full w-auto flex justify-between items-center gap-[20px]'>
                                <div className='flex flex-col w-[160px] sm:w-full h-[200px] gap-6 text-white'>
