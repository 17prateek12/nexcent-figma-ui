...
const Component2 = () => {
    ...
    return (
        <div className='max-w-[1440px] flex flex-col justify-center items-center gap-[11px] mx-auto navmd:h-auto my-16'>
            ...
            <div className='w-full flex justify-between px-[144px] sm:px-4 pt-8 items-center navmd:justify-center lg:flex-col gap-5'>
                {data.map((item, index) => (
                    <div key={index} className='bg-[#f5f7fa] h-[300px] w-[330px] sm:w-full rounded-md gap-4 
